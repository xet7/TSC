...
namespace TSC {
    ...
    public:
        ...
        // as well.
        static std::vector<cActor*> Create_Level_Objects_From_XML_Tag(const std::string& name, XmlAttributes& attributes, cLevel& level, int engine_version);
    ...
    private:
        ...
        static std::vector<cActor*> Create_Boxes_From_XML_Tag(const std::string& name, XmlAttributes& attributes, cLevel& level, int engine_version);
        // OLD static std::vector<cActor*> Create_Items_From_XML_Tag(const std::string& name, XmlAttributes& attributes, int engine_version, cSprite_Manager* p_sprite_manager);
        // OLD static std::vector<cActor*> Create_Moving_Platforms_From_XML_Tag(const std::string& name, XmlAttributes& attributes, int engine_version, cSprite_Manager* p_sprite_manager);
        // OLD static std::vector<cActor*> Create_Falling_Platforms_From_XML_Tag(const std::string& name, XmlAttributes& attributes, int engine_version, cSprite_Manager* p_sprite_manager);
        // OLD static std::vector<cActor*> Create_Enemies_From_XML_Tag(const std::string& name, XmlAttributes& attributes, int engine_version, cSprite_Manager* p_sprite_manager);
        // OLD static std::vector<cActor*> Create_Sounds_From_XML_Tag(const std::string& name, XmlAttributes& attributes, int engine_version, cSprite_Manager* p_sprite_manager);
        // OLD static std::vector<cActor*> Create_Particle_Emitters_From_XML_Tag(const std::string& name, XmlAttributes& attributes, int engine_version, cSprite_Manager* p_sprite_manager);
        // OLD static std::vector<cActor*> Create_Paths_From_XML_Tag(const std::string& name, XmlAttributes& attributes, int engine_version, cSprite_Manager* p_sprite_manager);
        // OLD static std::vector<cActor*> Create_Global_Effects_From_XML_Tag(const std::string& name, XmlAttributes& attributes, int engine_version, cSprite_Manager* p_sprite_manager);
        // OLD static std::vector<cActor*> Create_Balls_From_XML_Tag(const std::string& name, XmlAttributes& attributes, int engine_version, cSprite_Manager* p_sprite_manager);
        // OLD static std::vector<cActor*> Create_Lavas_From_XML_Tag(const std::string& name, XmlAttributes& attributes, int engine_version, cSprite_Manager* p_sprite_manager);
        // OLD static std::vector<cActor*> Create_Crates_From_XML_Tag(const std::string& name, XmlAttributes& attributes, int engine_version, cSprite_Manager* p_sprite_manager);

        void Parse_Tag_Information();
        void Parse_Tag_Settings();
        // OLD void Parse_Tag_Background();
