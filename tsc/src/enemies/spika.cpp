...
void cSpika::Set_Color(DefaultColor col)
{
    ...
    if (m_color_type == COL_ORANGE) {
        Add_Animation("main", "enemy/spika/orange.animation");
        ...
        Add_Animation("main", "enemy/spika/green.animation");
        ...
        Add_Animation("main", "enemy/spika/grey.animation");
        ...
        Add_Animation("main", "enemy/spika/red.animation");
