...
*/
inline void string_trim_from_begin( string &str, const char search )
{
...
*/
inline void string_trim( string &str, const char search )
{
...
// other platforms.
boost::filesystem::path utf8_to_path( const string &str );
// Convert a path created by utf8_to_path() platform-independently
// back to a UTF-8 string. On Windows, `path' is automatically
...
template<>
inline string type_to_string(bool value)
{
  return value ? "1" : "0";
}

template<>
inline float string_to_type(const string& value)
{
  return string_to_float(value);
}

template<>
inline int string_to_type(const string& value)
{
  return string_to_int(value);
}

template<>
inline long string_to_type(const string& value)
{
	return string_to_long(value);
}

template<>
inline bool string_to_type(const string& value)
{
  return string_to_bool(value);
}

template<>
inline string string_to_type(const string& value)
{
