...
namespace SMC {
	...
	public:
		...
		inline void Set_Radius(float r){ m_radius = r; }

		inline GL_point Get_Top_Left_Point(){ return GL_point(m_x - m_radius, m_y - m_radius); }
		inline GL_rect Get_Outer_Rect(){ return GL_rect(m_x - m_radius, m_y - m_radius, 2 * m_radius, 2 * m_radius); }
