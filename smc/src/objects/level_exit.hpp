...
#ifndef SMC_LEVEL_EXIT_HPP
#define SMC_LEVEL_EXIT_HPP
...
public:
	...
	{
		return mrb_obj_value(Data_Wrap_Struct(p_state, mrb_class_get(p_state, "Level_Exit"), &Scripting::rtSMC_Scriptable, this));
	}
