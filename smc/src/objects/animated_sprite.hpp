...
#include "../scripting/objects/sprites/mrb_animated_sprite.h"
...
public:
	...
	*/
	...
	{
		return mrb_obj_value(Data_Wrap_Struct(p_state, Scripting::p_rcAnimated_Sprite, &Scripting::rtSMC_Scriptable, this));
	}
