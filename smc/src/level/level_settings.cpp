...
void cLevel_Settings :: Init( void )
{
	...
	// get window manager and root window
	...
	// Main
	// level filename
	CEGUI::Editbox *editbox_level_filename = static_cast<CEGUI::Editbox *>(root->getChild( "editbox_level_filename" ));
	editbox_level_filename->setText( m_level->Get_Level_Name().c_str() );
	// music filename
	CEGUI::Editbox *editbox_music_filename = static_cast<CEGUI::Editbox *>(root->getChild( "editbox_music_filename" ));
	editbox_music_filename->setText( path_to_utf8(m_level->Get_Music_Filename()).c_str() );
	// author
	CEGUI::Editbox *editbox_author = static_cast<CEGUI::Editbox *>(root->getChild( "editbox_author" ));
	editbox_author->setText( reinterpret_cast<const CEGUI::utf8*>(m_level->m_author.c_str()) );
	// version
	CEGUI::Editbox *editbox_version = static_cast<CEGUI::Editbox *>(root->getChild( "editbox_version" ));
	editbox_version->setText( m_level->m_version.c_str() );
	// difficulty
	m_spinner_difficulty = static_cast<CEGUI::Spinner *>(root->getChild( "spinner_difficulty" ));
	...
	m_slider_difficulty = static_cast<CEGUI::Slider *>(root->getChild( "slider_difficulty" ));
	...
	m_text_difficulty_name = root->getChild( "text_difficulty_name" );
	m_text_difficulty_name->setText( Get_Difficulty_Name( m_level->m_difficulty ) );

	// land type
	CEGUI::Combobox *combo_land_type = static_cast<CEGUI::Combobox *>(root->getChild( "combo_land_type" ));
	// add all types
	...
	// description
	CEGUI::MultiLineEditbox *multieditbox_description = static_cast<CEGUI::MultiLineEditbox *>(root->getChild( "multieditbox_description" ));
	multieditbox_description->setText( reinterpret_cast<const CEGUI::utf8*>(m_level->m_description.c_str()) );

	// camera limits
	CEGUI::Spinner *spinner = static_cast<CEGUI::Spinner *>(root->getChild( "spinner_camera_limit_w" ));
	spinner->setCurrentValue( m_level->m_camera_limits.m_w );
	spinner = static_cast<CEGUI::Spinner *>(root->getChild( "spinner_camera_limit_h" ));
	spinner->setCurrentValue( m_level->m_camera_limits.m_h );
	// fixed camera horizontal velocity
	spinner = static_cast<CEGUI::Spinner *>(root->getChild( "spinner_camera_hor_vel" ));
	spinner->setCurrentValue( m_level->m_fixed_camera_hor_vel );
	// last save time
	CEGUI::Editbox *editbox_save_time = static_cast<CEGUI::Editbox *>(root->getChild( "editbox_save_time" ));
	editbox_save_time->setText( Time_to_String( m_level->m_last_saved, "%Y-%m-%d  %H:%M:%S" ) );


	// add background image button
	CEGUI::PushButton *button_add_background_image = static_cast<CEGUI::PushButton *>(root->getChild( "button_add_background_image" ));
	...
	CEGUI::PushButton *button_delete_background_image = static_cast<CEGUI::PushButton *>(root->getChild( "button_delete_background_image" ));
	...
	// apply button
	CEGUI::PushButton *button_apply = static_cast<CEGUI::PushButton *>(root->getChild( "button_apply" ));
	button_apply->subscribeEvent( CEGUI::PushButton::EventClicked, CEGUI::Event::Subscriber( &cLevel_Settings::Button_Apply, this ) );

	// Background
	// listbox
	CEGUI::Listbox *listbox = static_cast<CEGUI::Listbox *>(root->getChild( "listbox_backgrounds" ));
	...
	// type
	CEGUI::Combobox *combobox = static_cast<CEGUI::Combobox *>(root->getChild( "combo_bg_image_type" ));
	...
	// filename
	CEGUI::Editbox *editbox = static_cast<CEGUI::Editbox *>(root->getChild( "editbox_bg_image_name" ));
	editbox->subscribeEvent( CEGUI::Editbox::EventKeyUp, CEGUI::Event::Subscriber( &cLevel_Settings::Update_BG_Image, this ) );
	// speed
	spinner = static_cast<CEGUI::Spinner *>(root->getChild( "spinner_bg_image_speed_x" ));
	spinner->subscribeEvent( CEGUI::Spinner::EventKeyUp, CEGUI::Event::Subscriber( &cLevel_Settings::Update_BG_Image, this ) );
	spinner = static_cast<CEGUI::Spinner *>(root->getChild( "spinner_bg_image_speed_y" ));
	spinner->subscribeEvent( CEGUI::Spinner::EventKeyUp, CEGUI::Event::Subscriber( &cLevel_Settings::Update_BG_Image, this ) );
	// position
	editbox = static_cast<CEGUI::Editbox *>(root->getChild( "editbox_bg_image_posx" ));
	editbox->subscribeEvent( CEGUI::Editbox::EventKeyUp, CEGUI::Event::Subscriber( &cLevel_Settings::Update_BG_Image, this ) );
	editbox = static_cast<CEGUI::Editbox *>(root->getChild( "editbox_bg_image_posy" ));
	editbox->subscribeEvent( CEGUI::Editbox::EventKeyUp, CEGUI::Event::Subscriber( &cLevel_Settings::Update_BG_Image, this ) );
	editbox = static_cast<CEGUI::Editbox *>(root->getChild( "editbox_bg_image_posz" ));
	editbox->subscribeEvent( CEGUI::Editbox::EventKeyUp, CEGUI::Event::Subscriber( &cLevel_Settings::Update_BG_Image, this ) );
	// constant velocity
	spinner = static_cast<CEGUI::Spinner *>(root->getChild( "spinner_bg_image_const_vel_x" ));
	spinner->subscribeEvent( CEGUI::Spinner::EventKeyUp, CEGUI::Event::Subscriber( &cLevel_Settings::Update_BG_Image, this ) );
	spinner = static_cast<CEGUI::Spinner *>(root->getChild( "spinner_bg_image_const_vel_y" ));
	spinner->subscribeEvent( CEGUI::Spinner::EventKeyUp, CEGUI::Event::Subscriber( &cLevel_Settings::Update_BG_Image, this ) );
	// Gradient colors
	...
	// color 1
	editbox = static_cast<CEGUI::Editbox *>(root->getChild( "editbox_bg_color_start_red" ));
	...
	editbox = static_cast<CEGUI::Editbox *>(root->getChild( "editbox_bg_color_start_green" ));
	editbox->subscribeEvent( CEGUI::Editbox::EventKeyUp, CEGUI::Event::Subscriber( &cLevel_Settings::Update_BG_Colors, this ) );
	editbox->setText( int_to_string( m_bg_color_1.green ).c_str() );
	editbox = static_cast<CEGUI::Editbox *>(root->getChild( "editbox_bg_color_start_blue" ));
	editbox->subscribeEvent( CEGUI::Editbox::EventKeyUp, CEGUI::Event::Subscriber( &cLevel_Settings::Update_BG_Colors, this ) );
	editbox->setText( int_to_string( m_bg_color_1.blue ).c_str() );
	// color 2
	editbox = static_cast<CEGUI::Editbox *>(root->getChild( "editbox_bg_color_end_red" ));
	editbox->subscribeEvent( CEGUI::Editbox::EventKeyUp, CEGUI::Event::Subscriber( &cLevel_Settings::Update_BG_Colors, this ) );
	editbox->setText( int_to_string( m_bg_color_2.red ).c_str() );
	editbox = static_cast<CEGUI::Editbox *>(root->getChild( "editbox_bg_color_end_green" ));
	editbox->subscribeEvent( CEGUI::Editbox::EventKeyUp, CEGUI::Event::Subscriber( &cLevel_Settings::Update_BG_Colors, this ) );
	editbox->setText( int_to_string( m_bg_color_2.green ).c_str() );
	editbox = static_cast<CEGUI::Editbox *>(root->getChild( "editbox_bg_color_end_blue" ));
	editbox->subscribeEvent( CEGUI::Editbox::EventKeyUp, CEGUI::Event::Subscriber( &cLevel_Settings::Update_BG_Colors, this ) );
...
void cLevel_Settings :: Leave( void )
{
	...
	// # Main Tab
	// filename
	fs::path level_filename = utf8_to_path( root->getChild( "editbox_level_filename" )->getText().c_str() );
	...
	fs::path new_music = utf8_to_path( root->getChild( "editbox_music_filename" )->getText().c_str() );
	// if the music is new
	...
	// author
	m_level->Set_Author( root->getChild( "editbox_author" )->getText().c_str() );
	// version
	m_level->Set_Version( root->getChild( "editbox_version" )->getText().c_str() );
	// difficulty
	m_level->Set_Difficulty( static_cast<CEGUI::Spinner *>(root->getChild( "spinner_difficulty" ))->getCurrentValue() );
	// land type
	m_level->Set_Land_Type( Get_Level_Land_Type_Id( static_cast<CEGUI::Combobox *>(root->getChild( "combo_land_type" ))->getText().c_str() ) );
	// description
	m_level->Set_Description( static_cast<CEGUI::MultiLineEditbox *>(root->getChild( "multieditbox_description" ))->getText().c_str() );

	// Camera Limits
	pLevel_Manager->m_camera->Set_Limit_W( (static_cast<CEGUI::Spinner *>(root->getChild( "spinner_camera_limit_w" )))->getCurrentValue() );
	pLevel_Manager->m_camera->Set_Limit_H( (static_cast<CEGUI::Spinner *>(root->getChild( "spinner_camera_limit_h" )))->getCurrentValue() );
	...
	// fixed camera horizontal velocity
	pLevel_Manager->m_camera->m_fixed_hor_vel = (static_cast<CEGUI::Spinner *>(root->getChild( "spinner_camera_hor_vel" )))->getCurrentValue();
...
{
	CEGUI::Listbox *listbox = static_cast<CEGUI::Listbox *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "listbox_backgrounds" ));
...
bool cLevel_Settings :: Set_Background_Image( const CEGUI::EventArgs &event )
{
	...
	if( item )
	{
		...
		// type
		CEGUI::Editbox *editbox = static_cast<CEGUI::Editbox *>(root->getChild( "combo_bg_image_type" ));
		editbox->setText( reinterpret_cast<const CEGUI::utf8*>(background->Get_Type_Name().c_str()) );
		// filename
		editbox = static_cast<CEGUI::Editbox *>(root->getChild( "editbox_bg_image_name" ));
		...
		// speed
		CEGUI::Spinner *spinner = static_cast<CEGUI::Spinner *>(root->getChild( "spinner_bg_image_speed_x" ));
...
bool cLevel_Settings :: Update_BG_Colors( const CEGUI::EventArgs &event )
{
	...
	CEGUI::Editbox *color_start_red = static_cast<CEGUI::Editbox *>(root->getChild( "editbox_bg_color_start_red" ));
	CEGUI::Editbox *color_start_green = static_cast<CEGUI::Editbox *>(root->getChild( "editbox_bg_color_start_green" ));
	CEGUI::Editbox *color_start_blue = static_cast<CEGUI::Editbox *>(root->getChild( "editbox_bg_color_start_blue" ));
	CEGUI::Editbox *color_end_red = static_cast<CEGUI::Editbox *>(root->getChild( "editbox_bg_color_end_red" ));
	CEGUI::Editbox *color_end_green = static_cast<CEGUI::Editbox *>(root->getChild( "editbox_bg_color_end_green" ));
	CEGUI::Editbox *color_end_blue = static_cast<CEGUI::Editbox *>(root->getChild( "editbox_bg_color_end_blue" ));
...
void cLevel_Settings :: Load_BG_Image_List( void )
{
	...
	CEGUI::PushButton *button_add = static_cast<CEGUI::PushButton *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "button_add_background_image" ));
...
bool cLevel_Settings :: Update_BG_Image( const CEGUI::EventArgs &event )
{
	...
	std::string bg_type = root->getChild( "combo_bg_image_type" )->getText().c_str();
	std::string bg_name = root->getChild( "editbox_bg_image_name" )->getText().c_str();
	float posx = string_to_float( (root->getChild( "editbox_bg_image_posx" ))->getText().c_str() );
	float posy = string_to_float( (root->getChild( "editbox_bg_image_posy" ))->getText().c_str() );
	float posz = string_to_float( (root->getChild( "editbox_bg_image_posz" ))->getText().c_str() );
	float speed_x = (static_cast<CEGUI::Spinner *>(root->getChild( "spinner_bg_image_speed_x" )))->getCurrentValue();
	float speed_y = (static_cast<CEGUI::Spinner *>(root->getChild( "spinner_bg_image_speed_y" )))->getCurrentValue();
	float const_vel_x = (static_cast<CEGUI::Spinner *>(root->getChild( "spinner_bg_image_const_vel_x" )))->getCurrentValue();
	float const_vel_y = (static_cast<CEGUI::Spinner *>(root->getChild( "spinner_bg_image_const_vel_y" )))->getCurrentValue();
...
void cLevel_Settings :: Clear_Layer_Field( void )
{
	...
	root->getChild( "combo_bg_image_type" )->setText( "Disabled" );
	root->getChild( "editbox_bg_image_name" )->setText( "" );
	root->getChild( "editbox_bg_image_posx" )->setText( "" );
	root->getChild( "editbox_bg_image_posy" )->setText( "" );
	root->getChild( "editbox_bg_image_posz" )->setText( "" );
	root->getChild( "spinner_bg_image_speed_x" )->setText( "" );
	root->getChild( "spinner_bg_image_speed_y" )->setText( "" );
	root->getChild( "spinner_bg_image_const_vel_x" )->setText( "" );
	root->getChild( "spinner_bg_image_const_vel_y" )->setText( "" );
}
