...
MRuby::CrossBuild.new("mingw32") do |conf|
  # load specific toolchain settings
  toolchain :gcc

  conf.cc do |cc|
    cc.command = ENV["CC"] || "i686-pc-mingw32-gcc"
  end

  conf.linker do |linker|
    linker.command = ENV["LD"] || "i686-pc-mingw32-gcc"
  end

  conf.archiver do |archiver|
    archiver.command = ENV["AR"] || "i686-pc-mingw32-ar"
  end
